...
<header class="header" style="z-index:1;">
    ...
    <a href="http://localhost/Khalie/Khalia_Ahl_Fes/" class="logo"> <i class="fas fa-shopping-basket"></i> Khalie Ahl Fes </a>

    <nav class="navbar">
        <a href="http://localhost/Khalie/Khalia_Ahl_Fes/">home</a>
...
<!--End last section-->
<!-- Start La securite Alimentaire section -->
